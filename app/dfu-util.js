// HiChord firmware updater - simplified firmware-only version
// Uses exact DFU logic with pre-loaded binary file
    ...
    document.addEventListener('DOMContentLoaded', event => {
        ...
        async function connect(device) {
            ...
            if (desc && Object.keys(desc).length > 0) {
                ...
                // CRITICAL: Create dfuse.Device for DfuSe protocol
            ...
            // CRITICAL: Set start address with QSPI offset
            if (device.memoryInfo) {
        ...
        // CRITICAL: Interface selection filtering
        ...
        downloadButton.addEventListener('click', async function(event) {
            ...
            if (device && firmwareFile != null) {
                ...
                // CRITICAL: Upload firmware using do_download
                await device.do_download(transferSize, firmwareFile, manifestationTolerant).then(
                    () => {
                        logInfo("Done! Firmware update complete.");
